...
class StringOneDimArray
{
  ...
  public:
    ...
    void toInt(LVOneDimArray<unsigned char> &output)
    {
    ...
    void toInt(LVOneDimArray<signed char> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<unsigned short> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<signed short> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<unsigned long> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<signed long> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<float> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toInt(LVOneDimArray<double> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<unsigned char> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<signed char> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<unsigned short> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<signed short> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<unsigned long> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<signed long> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<float> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
    ...
    void toFloat(LVOneDimArray<double> &output)
    {
      if(output.resizeArr(data_size) != NULL)
      {
        for(int i=0; i<data_size; i++)
